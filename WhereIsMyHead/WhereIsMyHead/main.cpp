...
void go3dMode(glm::mat4* model, glm::mat4* projection, glm::mat4* view, Shader* shader, unsigned int* VAO);
...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "DEAD", NULL, NULL);
